	...
	<div class="contenedor">
	   <div class="contenedor_filtrar">
		   ...
		   <!-- <div class="btn_descargar" onclick="generaPDF();">
		       <img class="icono_descargar" src="<?php // echo base_url(); ?>/images/sitio/reporte_pro/boletin/icono_descargar.png">
						...
						<table class="table_3B">
							<thead>
								<tr>
									...
									<th class="fondo_titulo_lista">Cant. Cat. Ventas</th>
									<th class="fondo_titulo_lista">Cant. Cat. Ejec</th>
								</tr>
							</thead>
							<?php
...
<script type="text/javascript">
	...
	<?php if($ID_INMOBILIARIA == 96){ ?>
		...
		$("#filtro_zona").val("<?= $idZona; ?>");
	<?php } ?>
	$("#filtro_anio").val("<?= $fechaAnio; ?>");
	$("#filtro_mes").val("<?= $fechaMes; ?>");
...
function salir(){
	window.location = 'https://gleads.tgapps.net/valentina/entrada/close_user';
}
function volver(){
	window.location = 'https://gleads.tgapps.net/reportes';
}
function filtrar(){
	...
	window.location = "https://gleads.tgapps.net/boletin?anio="+filtro_anio+"&mes="+filtro_mes+"&zona="+filtro_zona;
}
function generaPDF(){
