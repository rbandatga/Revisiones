...
class Boletin extends CI_Controller {
    public function __construct(){
        ...
        $this->load->model('boletin/Boletinmodel');
    ...
    public function index(){
        ...
        $data['CssLlama2']            = "css/sitio/a1gleads_admin/home.css";
        ...
        $js1                          = '<script type="text/javascript" src="'.base_url().'js/sitio/boletin/exporting.js"></script>'."\n";
        $js2                          = '<script type="text/javascript" src="'.base_url().'js/sitio/boletin/offline-exporting.js"></script>';
        $data['cargaAnexa1']          = $js1.$js2;

        $this->load->view('valentina/paginas/llama_pagina',$data);
    }
    public function Descarga_boletin(){
        $this->load->view('boletin/captcha.php');
    }
}
