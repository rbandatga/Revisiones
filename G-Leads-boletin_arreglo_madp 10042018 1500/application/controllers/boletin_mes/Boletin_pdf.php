...
class Boletin_pdf extends CI_Controller {
    ...
    public function index(){
		...
		if(base_url() == "https://gleads.tgapps.net/" || base_url() == "http://prueba-gleads.prueba.cool"){
			$GubicacionLocal 	   = "/var/www/vhosts/desarollo.cool/gleads.desarrollo.cool/images/deposito/";
		}
		...
		$GGuardo			= file_put_contents($GubicacionFinalLocal, $svg_volumen);
		$GGuardo2			= file_put_contents($GubicacionFinal2Local, $svg_origen);
...
/*		$arrPortales	 = array();
		...
		##############################
		$tagTableBig 				= '<table width="100%"  class="tab_4" cellpadding="4" align="center"><thead><tr><td class="tab_4head">Nombre ejecutivo</td><td class="tab_4head">Cant. Cat. Ejec</td><td class="tab_4head">Cant. Cat. Ventas</td></tr></thead><tbody><tr><td width="45%">';
		$tagTablaSub				= '<table>';
		...
		*/
		...
		$guardarComo		= "Boletin_mensual_" . $fechaAnio . "-" . $fechaAnio . ".pdf";
		$pdf->Output($guardarComo, 'I');exit;
    }
}
?>
