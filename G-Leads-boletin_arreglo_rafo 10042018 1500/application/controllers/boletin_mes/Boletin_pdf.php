    ...
    public function index(){
		...
		<table width="100%" style="border-bottom: 1px solid #ededed; color: #636262;">
			<tr style="vertical-align: middle;">
				...
				<td width="20%" style="background-color: #c1212b;  text-align: center; color: white; font-size: 9pt; font-family: "Times New Roman";">' . $fecha . '</td>
			</tr>
			<tr>
				<td width="60%">
					&nbsp;
...
/*		$arrPortales	 = array();
		...
		$vueltasMaximas 		= 4;			//Cantidad de vueltas por subTabla
